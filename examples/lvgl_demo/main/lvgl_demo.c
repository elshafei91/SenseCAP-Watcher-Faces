...
/* LCD pins */
#define EXAMPLE_LCD_GPIO_SCLK (7)
#define EXAMPLE_LCD_GPIO_MOSI (9)
#define EXAMPLE_LCD_GPIO_RST (8)
#define EXAMPLE_LCD_GPIO_DC (4)
#define EXAMPLE_LCD_GPIO_CS (2)
#define EXAMPLE_LCD_GPIO_BL (43)
...
#define EXAMPLE_TOUCH_I2C_SDA (5)
#define EXAMPLE_TOUCH_GPIO_INT (44)
...
static esp_err_t app_touch_init(void)
{
    ...
    return esp_lcd_touch_new_i2c_chsc6x(tp_io_handle, &tp_cfg, &touch_handle);
}
