...
{
ui_ui_startup = lv_obj_create(NULL);
lv_obj_clear_flag( ui_ui_startup, LV_OBJ_FLAG_SCROLLABLE );    /// Flags

ui_logo = lv_img_create(ui_ui_startup);
lv_img_set_src(ui_logo, &ui_img_ui_img_logo_png);
