...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>Output</td>
      <td>TF_DATA_TYPE_DUALIMAGE_WITH_AUDIO_TEXT</td>
      <td>Output large image, small image, alarm mp3 audio, and text</td>
    </tr>
  </tbody>
</table>
...
- Big Image Len - Byte length of the base64 encoded string of the large image
- Big Image - Base64 encoded string of the large image JPG
- Small Image Len - Byte length of the base64 encoded string of the small image
