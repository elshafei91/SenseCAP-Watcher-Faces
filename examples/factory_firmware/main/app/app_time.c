...
int app_time_init(void)
{
    ...
    ESP_ERROR_CHECK(esp_event_handler_instance_register_with(view_event_handle, VIEW_EVENT_BASE, VIEW_EVENT_TIME_CFG_APPLY, __view_event_handler, NULL, NULL));
    ...
    ESP_ERROR_CHECK(esp_event_handler_instance_register_with(view_event_handle, VIEW_EVENT_BASE, VIEW_EVENT_TIME_ZONE, __view_event_handler, NULL, NULL));
    return 0;
}
