...
void ui_Page_main_screen_init(void)
{
    ...
    lv_obj_set_style_bg_img_src(ui_mainbtn1, &ui_img_1798082340, LV_PART_MAIN | LV_STATE_CHECKED);
    ...
    lv_obj_set_style_bg_img_src(ui_mainbtn1, &ui_img_1798082340, LV_PART_MAIN | LV_STATE_FOCUSED);
    ...
    lv_obj_set_style_bg_img_src(ui_mainbtn2, &ui_img_476189949, LV_PART_MAIN | LV_STATE_FOCUSED);
    ...
    lv_obj_set_style_bg_img_src(ui_mainbtn2, &ui_img_476189949, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_set_style_bg_img_src(ui_mainbtn3, &ui_img_335953020, LV_PART_MAIN | LV_STATE_FOCUSED);
    ...
    lv_obj_set_width(ui_maincontent, 238);
    lv_obj_set_height(ui_maincontent, 240);
    lv_obj_set_x(ui_maincontent, 38);
    ...
    lv_obj_set_width(ui_Devicep, 164);
    ...
    lv_img_set_src(ui_mainb, &ui_img_battery_5_png);
